    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0 px-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-4 py-lg-0">
                <a href="<?= BASEURL ?>/"
                    class="nav-item nav-link <?= ($data['judul'] === 'Dashboard') ? 'active' : '' ?>">Home</a>
                <a href="<?= BASEURL ?>/berita"
                    class="nav-item nav-link <?= ($data['judul'] === 'Berita') ? 'active' : '' ?>">Berita</a>
                <a href="<?= BASEURL ?>/Cek_Jantung"
                    class="nav-item nav-link <?= ($data['judul'] === 'Cek Jantung') ? 'active' : '' ?>">Cek Jantung</a>
                <a href="<?= BASEURL ?>/tentang_kami"
                    class="nav-item nav-link <?= ($data['judul'] === 'Tentang Kami') ? 'active' : '' ?>">Tentang
                    Kami</a>
