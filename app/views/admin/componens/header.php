      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <div class="app-brand demo">
          <a href="<?= BASEURL?>/admin/" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">HeartInsight</span>
          </a>
        ...
        <ul class="menu-inner py-1">
          ...
          <!-- Misc -->
          <li class="menu-header small text-uppercase"><span class="menu-header-text">Help & Support</span></li>
          <li class="menu-item">
