                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center d-flex flex-column gap-2">
                            <a href="<?= BASEURL; ?>/Dashboard/index" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">HeartInsight</span>
                            </a>

                            <p class="fs-6 fw-semibold">Regitrasi Akun Admin</p>
                        </div>
                        <!-- /Logo -->
                        <!-- <h4 class="mb-2 mt-n3">Perjalanan dimulai disini 🚀</h4>
                        <p class="mb-3">Buat Belajarmu nyaman dan menyenangkan</p> -->

                        <form action="<?= BASEURL; ?>/auth/pendaftaran" method="post" enctype="multipart/form-data">
                            <div class="mb-3">
