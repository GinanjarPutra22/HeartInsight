    ...
    <div class="col-3 ">
        <div class="d-grid gap-3 d-md-flex d-flex justify-content-md-end">
            <div class=" text-center">
                <button type="button" class="btn btn-primary ModalTambahBerita" data-bs-toggle="modal" data-bs-target="#formModalBerita">
                    Tambah Materi
                </button>
            </div>
        </div>
            ...
            <tr class="text-center align-baseline gap-5">
                <td>       
                    <div class="d-grid gap-2 d-md-flex d-flex justify-content-md-center">
                        <a href="<?= BASEURL;?>/kelola_berita/ubah/<?= $berita['id_berita']?>" 
                            class="btn btn-primary me-md-2 btn-sm ModalUbahBerita" 
                            data-bs-toggle="modal" data-bs-target="#formModalBerita" 
                            data-id="<?= $berita['id_berita']?>">Detail</a>
